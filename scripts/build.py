...
def entry_point():
    ...
    parser.add_argument('--split-lines', default=1000000, help='Split wordlists by lines no')
    ...
    combinator = clss(config.RULES, config.WORDLISTS, config.COMBINATOR_PATH, config.RLI2_PATH, args.temporary_dir, top_dir, args.output_dir, args.split_lines)
    combinator.run()
