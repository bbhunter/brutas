    ...
    def process(self):
        ...
        self.merge(
            ...
            (
                ...
                self.rule_process(f'{self.base_dir}/hax0r-brutas-usernames+extra-common.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/hax0r-brutas-usernames+extra-less.txt', 'complex'),
    ...
    def process(self):
        ...
        self.merge(
            ...
            (
                ...
                self.combine_right('months+separators+hax0r-brutas-custom', 'extra-common'),
                self.combine_right('months+separators+repeat-brutas-custom', 'extra-common'),
                ...
                self.rule_process(f'{self.base_dir}/extra-all+hax0r-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/extra-all+repeat-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/extra-all+simple-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/hax0r-brutas-custom+extra-all.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/hax0r-brutas-custom+numbers-all.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/numbers-all+hax0r-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/numbers-all+repeat-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/numbers-all+simple-brutas-custom.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/repeat-brutas-custom+extra-all.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/repeat-brutas-custom+numbers-all.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/simple-brutas-custom+extra-all.txt', 'complex'),
                self.rule_process(f'{self.base_dir}/simple-brutas-custom+numbers-all.txt', 'complex'),
