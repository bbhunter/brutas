...
sort -f keywords/brutas-en-common.txt > $TEMP_DIR/en-sorted1
sort -f keywords/brutas-en-less.txt > $TEMP_DIR/en-sorted2
comm -13 $TEMP_DIR/en-sorted1 $TEMP_DIR/en-sorted2 > keywords/brutas-en-less.txt
...
comm -13 keywords/brutas-subdomains.txt keywords/brutas-subdomains-extra.txt >> brutas-subdomains-1-small.txt
