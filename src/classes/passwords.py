...
class BasicPasswords(Passwords):
    ...
    def process(self):
        ...
        usernames = self.temp('simple-usernames-basic.txt')
        usernames_sep = self.temp('simple-usernames-basic+separators.txt')
        ...
        self.merge(
            ...
            (
                ...
                self.left(usernames, self.base('src/bits/extra-basic.txt')),
                self.left(usernames, self.base('src/bits/functional.txt')),
                self.right(usernames, self.base('src/bits/extra-basic.txt')),
                self.right(usernames, self.base('src/bits/numbers-basic.txt')),
                self.right(usernames, self.base('src/bits/years-current.txt')),
                self.right(self.temp('simple-usernames-basic+extra-basic.txt'), self.base('src/bits/years-current.txt')),
                self.right(usernames_sep, self.base('src/bits/functional.txt')),
                self.right(usernames_sep, self.base('src/bits/months.txt')),
                self.right(usernames_sep, self.base('src/bits/years-current.txt')),
        ...
        self.merge(
            ...
            (
                ...
                self.rule(
                    self.rule(self.base('wordlists/usernames/basic.txt'), self.base('src/rules/repeat.rule')),
...
class ExtendedPasswords(Passwords):
    ...
    def process(self):
        ...
        usernames = self.temp('simple-usernames-all.txt')
        ...
        self.merge(
            ...
            (
                self.left(usernames, self.base('src/bits/extra-basic.txt')),
                self.left(usernames, self.base('src/bits/functional.txt')),
                self.left(usernames, self.base('src/bits/numbers-basic.txt')),
                ...
                self.right(usernames, self.base('src/bits/extra-basic.txt')),
                self.right(usernames, self.base('src/bits/extra-extended.txt')),
                self.right(usernames, self.base('src/bits/numbers-basic.txt')),
                self.right(usernames, self.base('src/bits/years-all.txt')),
        ...
        self.merge(
            ...
            (
                self.both(self.temp('repeat-usernames-all.txt'), self.base('src/bits/extra-basic.txt')),
...
class BigPasswords(Passwords):
    ...
    def process(self):
        ...
        self.merge(
            ...
            (
                self.both(self.temp('repeat-usernames-all.txt'), self.base('src/bits/extra-extended.txt')),
    ...
    def process(self):
        self.merge(
            ...
            (
                ...
                self.right(self.temp('hax0r-keywords-custom.txt'), self.base('src/bits/numbers-basic.txt')),
                ...
                self.right(self.temp('hax0r-keywords-custom+numbers-basic.txt'), self.base('src/bits/extra-all.txt')),
                ...
                self.right(self.temp('months+separators+simple-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.right(self.temp('years-current+separators+hax0r-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('years-current+separators+repeat-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('years-current+separators+simple-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.rule(self.temp('hax0r-keywords-custom+numbers-basic.txt'), self.base('src/rules/complex.rule')),
