    ...
    def process(self):
        self.merge(
            ...
            (
                ...
                self.both(self.temp('repeat-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.left(self.temp('simple-keywords-custom+numbers-basic.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.left(self.temp('simple-keywords-custom.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.left(self.temp('simple-keywords-custom.txt'), self.base('src/bits/numbers-extended.txt')),
                ...
                self.right(self.temp('extra-basic+simple-keywords-custom.txt'), self.base('src/bits/months.txt')),
                self.right(self.temp('extra-basic+simple-keywords-custom.txt'), self.base('src/bits/years-all.txt')),
                self.right(self.temp('extra-basic+simple-keywords-custom.txt'), self.base('src/bits/years-current.txt')),
                ...
                self.right(self.temp('hax0r-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('hax0r-keywords-custom.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.right(self.temp('numbers-basic+simple-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('numbers-basic+simple-keywords-custom.txt'), self.base('src/bits/extra-extended.txt')),
                self.right(self.temp('numbers-extended+simple-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('numbers-extended+simple-keywords-custom.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+extra-basic.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('simple-keywords-custom+extra-basic.txt'), self.base('src/bits/months.txt')),
                self.right(self.temp('simple-keywords-custom+extra-basic.txt'), self.base('src/bits/years-all.txt')),
                self.right(self.temp('simple-keywords-custom+extra-basic.txt'), self.base('src/bits/years-current.txt')),
                self.right(self.temp('simple-keywords-custom+extra-extended.txt'), self.base('src/bits/months.txt')),
                self.right(self.temp('simple-keywords-custom+extra-extended.txt'), self.base('src/bits/years-all.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+months.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('simple-keywords-custom+months.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+numbers-basic.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('simple-keywords-custom+numbers-basic.txt'), self.base('src/bits/extra-extended.txt')),
                self.right(self.temp('simple-keywords-custom+numbers-extended.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('simple-keywords-custom+numbers-extended.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+separators.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+years-all.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+years-current.txt'), self.base('src/bits/extra-basic.txt')),
                ...
                self.right(self.temp('simple-keywords-custom.txt'), self.base('src/bits/extra-extended.txt')),
                ...
                self.right(self.temp('simple-keywords-custom.txt'), self.base('src/bits/numbers-extended.txt')),
                ...
                self.right(self.temp('simple-keywords-custom+separators.txt'), self.base('src/bits/numbers-basic.txt')),
                self.right(self.temp('simple-keywords-custom+separators.txt'), self.base('src/bits/numbers-extended.txt')),
                self.right(self.temp('simple-keywords-custom+separators.txt'), self.base('src/bits/years-all.txt')),
                self.right(self.temp('simple-keywords-custom.txt'), self.base('src/bits/extra-basic.txt')),
                self.right(self.temp('simple-keywords-custom.txt'), self.base('src/bits/months.txt')),
                self.right(self.temp('simple-keywords-custom.txt'), self.base('src/bits/numbers-basic.txt')),
                ...
                self.rule(self.temp('hax0r-keywords-custom+extra-basic.txt'), self.base('src/rules/capitalize.rule')),
                self.rule(self.temp('hax0r-keywords-custom+extra-basic.txt'), self.base('src/rules/complex.rule')),
                self.rule(self.temp('hax0r-keywords-custom+extra-extended.txt'), self.base('src/rules/capitalize.rule')),
                self.rule(self.temp('hax0r-keywords-custom+extra-extended.txt'), self.base('src/rules/complex.rule')),
                ...
                self.temp('capitalize-tmp-hax0r-keywords-custom+extra-basic.txt'),
                self.temp('capitalize-tmp-hax0r-keywords-custom+extra-extended.txt'),
